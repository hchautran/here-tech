"""DINOv2 model wrapper for feature extraction and similarity comparison"""
import os
import random
import torch
...
class DINOv2Model:
    """Wrapper class for DINOv2 model operations"""

    def __init__(self, model_name="dinov2_vitl14", device=None, gpu_id="1"):
        """
        ...
        Args:
            ...
            gpu_id: GPU ID to use (default: "1")
        """
        # Set GPU device
        ...
        print(f"\nDevice: {self.device}")
        print(f"\nLoading DINOv2 {model_name} model...")
